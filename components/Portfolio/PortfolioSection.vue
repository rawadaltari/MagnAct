...
<template>
  <div class="flex flex-col items-center justify-center min-h-screen w-full bg-[#0b0c0d] relative overflow-hidden">
    ...
    <!-- Decorative Elements -->
    <img class="absolute w-[300px] md:w-[537px] h-[437px] bottom-0 left-0 z-0" src="/img/elements1.png" alt="Decorative Element" />
    <img class="absolute w-[300px] md:w-[537px] h-[437px] bottom-0 right-0 z-0" src="/img/elements2.png" alt="Decorative Element" />
  </div>
</template>
